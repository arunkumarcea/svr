...
chumma=chumma[:500]
print("\tPrecision RBF: %1.3f" % mean_squared_error(y, y_rbf))
print("\tPrecision Linear: %1.3f" % mean_squared_error(y, y_lin))
print("\tPrecision Polynomial d2: %1.3f" % mean_squared_error(y, y_poly))
###############################################################################
# look at the results
